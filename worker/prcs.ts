...
export function scorePRCS(answers:PRCSAnswers,exactDropout=true){
 ...
 const common={model_version:model.model_version,selection_version:model.selection_version,model_fingerprint:model.official_model_fingerprint,context_taxonomy_version:model.context_taxonomy_version,response_counts:{answered:idx.length,missing:60-idx.length,directional,midpoint:idx.length-directional},total_items:60};
