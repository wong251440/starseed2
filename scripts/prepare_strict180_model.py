...
SOURCE = ROOT / 'starseed_s4_rpd_web_handoff_v4_1_min'
...
asset_path = '/model/s4rpd-v4.1-99f5e4ac3bbf.bin.gz'
data = bytearray()
layout = {}
...
# Keep the larger RPD model below Workers' 25 MiB per-asset limit losslessly.
...
print(f'{output.relative_to(ROOT)}: {output.stat().st_size:,} compressed bytes; {len(data):,} decoded bytes (native precision retained)')
