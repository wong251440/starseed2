...
describe('current full PRCS scorer',()=>{
 it('is deterministic for the active 54-item model and empirical calibration',()=>{
  ...
  expect(first).toMatchObject({model_version:'PRCS-v2.0',selection_version:'V4-RPCB-FULL54',calibration_version:'PRCS-CAL-WGT-v0.4-20260919',total_items:54,primary:'PL'});
 });
});
