# Starseed 21 — S4-RPD60 Production website handoff

Build a polished consumer quiz website from the frozen assets in this folder. You have **no research/model-design task**. Do not redesign the questions, item order, score model, lineage definitions, option order, or stability formula.

## Frozen production stack

- Questionnaire: **S4-RPD60 Production Final 60**
- Selection ID: **a9cf7bedbc70**
- Model: **S21-scoring-v4.1-s4rpd-99f5e4ac3bbf**
- Formats: **26 Bipolar + 14 Best–Worst + 20 Crossed Priority**
- Coordinates: **228 legal-response-whitened contrast coordinates**
- Exact evidence families: **58**
...
Everything from candidate generation, RPD selection research, hidden red-team audits, previous champions and championship comparisons is intentionally omitted.
...
- expose canonical IDs, A3/B3/C3/D3 source names, RPD taxonomy, internal Goal/Operation/Scope codes, evidence families, pair angles or target lineages during answering;
...
- questions 1–26: Bipolar
- questions 27–40: Best–Worst
- questions 41–60: Crossed Priority
...
```json
{
  "responses": {
    "S4RPD-A3-B10": 5,
    "S4RPD-A3-W31": {"best": "C", "worst": "A"},
    "S4RPD-A3-X50": {"operation": 2, "goal": 3}
  }
}
```
